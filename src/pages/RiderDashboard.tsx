...
export function RiderDashboard() {
  ...
  const todayEarnings = completedOrders
    .filter(o => {
      const completedDate = o.completedAt ? new Date(o.completedAt) : null;
  ...
  const handleUpdateStatus = async (orderId: string, newStatus: OrderStatus, extraData?: any) => {
    if (!userData) return;
    ...
    try {
      await orderService.updateStatus(orderId, newStatus, userData.uid, extraData);
      await refreshRiderOrders();
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge className="bg-[#1A7A7E] text-white ml-2">
        ...
        >
          ...
          <div className="mb-8">
            <h1 className="text-2xl sm:text-3xl font-semibold text-[#092635] font-['Poppins']">
              Good Morning, {userData?.displayName?.split(' ')[0] || 'Rider'}!
            </h1>
            <p className="text-[#4A6375] mt-1">
              You have {activeOrders.length} active jobs and {pendingOrders.length} available orders
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <Card className="border-none shadow-sm">
              <CardContent className="p-5">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-[#4A6375]">Active Jobs</p>
            ...
            <Card className="border-none shadow-sm">
              <CardContent className="p-5">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-[#4A6375]">Weekly Completed</p>
            ...
            <Card className="border-none shadow-sm">
              <CardContent className="p-5">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-[#4A6375]">Rating</p>
                    <p className="text-2xl font-semibold text-[#092635]">4.9</p>
                  </div>
...
function ActiveJobCard({ 
  ...
  const getActionButton = () => {
    ...
    // Special handling for pickup - open pickup dialog
    ...
    // Special handling for delivery - open delivery dialog
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[#092635]">{new Date(order.pickupDate).toLocaleDateString()}</span>
              </div>
...
function PickupDialog({
  ...
  const itemCountMatch = actualItemCount === order.declaredItemCount;
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            {!itemCountMatch && actualItemCount > 0 && (
              <p className="text-sm text-orange-600 mt-2 flex items-center gap-1">
                <AlertCircle className="w-4 h-4" />
                Item count doesn&apos;t match declared amount. Please add a note.
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Any notes about the pickup (e.g., item condition, discrepancies, etc.)"
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-[#4A6375] mb-3">
              Take a photo of the delivered laundry for proof (recommended)
            </p>
